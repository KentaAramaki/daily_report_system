...
public class EmployeeValidator {
     ...
     * @param codeDuplicateCheckFlag社員番号の重複チェックを実施するかどうか（実施する：true 実施しない：false）
     ...
     * @param service EmployeeServiceのインスタンス
     * @param code社員番号
     * @return従業員テーブルに登録されている同一社員番号のデータの件数
     */
     ...
     * @param passwordパスワード
     * @param passwordCheckFlagパスワードの入力チェックを実行するかどうか（実施する：true 実施しない：false）
     * @returnエラーメッセージ
     */
